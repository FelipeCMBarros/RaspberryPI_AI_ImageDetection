...
def run(model: str, max_results: int, score_threshold: float, num_threads: int,
  ...
  while cap.isOpened():
    ...
    for idx, category in enumerate(categories.classifications[0].categories):
      ...
      categoria.append(category_name)
      print(categoria)
...
def main():
  ...
  if  categoria[1] == "water bottle" or categoria[2] == "water bottle" or categoria[3] == "water bottle":
      categoria.clear()
      ...
      image = cv2.imread("/home/pi/Desktop/1K_G3/QR_codeFINAL.png")
